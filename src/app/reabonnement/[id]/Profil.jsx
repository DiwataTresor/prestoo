    ...
    <div className='flex justify-center items-center'>
      <div className='border rounded-md px-4 w-[40%] h-fit py-5 shadow-md border-gray-100 flex flex-col justify-center items-center'>
        ...
        <div className='flex flex-col gap-6'>
          <p className='bg-gray-100 px-2 py-2'>Abonnement : {profil?.typeabonnement} - Durée : {data?.nbreAnnee} Années</p>
        ...
        <div className='flex gap-5 mt-5 border-t pt-4 w-full justify-center items-center'>
          <Button color='primary' onPress={()=>{
            Modal.confirm({
              ...
              onOk:() => {
                setSpinning(true);
                postData("renouvellerSuccess",{profilId:profil?.id})
                .then((r) => {
                  if(r.success)
                  {
          ...
          }}><CheckCheckIcon /> Renouveller</Button>
