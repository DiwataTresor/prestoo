...
const Slide = ({ idSlide, mode, typeSlide }) => {
                                    ...
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        >
                                            ...
                                            <div className='absolute right-3 top-3 flex flex-col items-start justify-start w-[700px] pt-[100px] text-white'>
                                                ...
                                                >{slide1Elt?.text?.txt3?.content}</p>
                                                <p className='mt-9 flex gap-3'>
                                                    {mode=="live" && slide1Elt.btn.btn1.lien.trim()!==""?
                                                        <Link href={slide1Elt.btn.btn1.lien}>
                                                            <Button startContent={"text"} 
                                                            onClick={() => edit({ id: "btn1", textContent: slide1Elt?.btn?.btn1?.content, type: "btn" })} 
                                                            variant='solid' onChange={() => { }} color={slide1Elt.btn.btn1.color} 
                                                            className={`rounded-full ${mode=="live" && slide1Elt.btn.btn1.hidden===true?"hidden":null}`}>
                                                                    {slide1Elt.btn.btn1.hidden && <EyeOff />} {slide1Elt.btn.btn1.content}
                                                            </Button>
                                                        </Link>:
                                                        <Button startContent={"text"} 
                                                            onClick={() => edit({ id: "btn1", textContent: slide1Elt?.btn?.btn1?.content, type: "btn" })} 
                                                    ...
                                                    {mode=="live" && slide1Elt.btn.btn1.lien.trim()!==""?
                                                        <Link href={slide1Elt.btn.btn2.lien}><Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style} ${mode=="live" && slide1Elt.btn.btn2.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button></Link>:
                                                        <Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style} ${mode=="live" && slide1Elt.btn.btn2.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button>
                                                    }
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        {/* POUR SLIDE 1 */}
                                         <>
                                            ...
                                            >
                                                ...
                                                <div className='absolute left-3 top-3 flex flex-col items-start justify-start w-[700px] pt-[100px] text-white'>
                                                    <p onClick={() => {
                                                    ...
                                                    >{slide1Elt?.text?.txt3?.content}</p>
                                                    <p className='mt-9 flex gap-3'>
                                                        <Button startContent={"text"} onClick={() => edit({ id: "btn1", textContent: slide1Elt?.btn?.btn1?.content, type: "btn" })} variant='solid' onChange={() => { }} color={slide1Elt.btn.btn1.color} className={``}>{slide1Elt.btn.btn1.hidden && <EyeOff />} {slide1Elt.btn.btn1.content}</Button>
                                                        {/* <Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button> */}
                                                    </p>
                                                </div>
                                                <div className='h-[400px] w-[300px] absolute right-3'>
                                                    <Image src={imgUser ?? user1} fill />
                                                    {mode == "edition" && <Button
                                                        className='mt-[40%]'
                                                        onClick={() => { edit({ id: "user", lien: slide1Elt?.background, type: "img" }) }}
                                    ...
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        >
                                            ...
                                            <div className='absolute left-3 top-3 flex flex-col items-start justify-start w-[700px] pt-[100px] text-white'>
                                                ...
                                                <p className='mt-9 flex gap-3'>
                                                    {mode=="live" && slide1Elt.btn.btn1.lien.trim()!==""?
                                                    <Link href={slide1Elt.btn.btn1.lien}><Button startContent={"text"} onClick={() => edit({ id: "btn1", textContent: slide1Elt?.btn?.btn1?.content, type: "btn" })} variant='solid' onChange={() => { }} color={slide1Elt.btn.btn1.color} className={`rounded-full ${mode=="live" && slide1Elt.btn.btn1.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn1.hidden && <EyeOff />} {slide1Elt.btn.btn1.content}</Button></Link>:
                                                    <Button startContent={"text"} onClick={() => edit({ id: "btn1", textContent: slide1Elt?.btn?.btn1?.content, type: "btn" })} variant='solid' onChange={() => { }} color={slide1Elt.btn.btn1.color} className={`rounded-full ${mode=="live" && slide1Elt.btn.btn1.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn1.hidden && <EyeOff />} {slide1Elt.btn.btn1.content}</Button>}
                                                    {/* <Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button> */}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        {/* POUR SLIDE 1 */}
                                         <>
                                            ...
                                            >
                                                ...
                                                <div className=' top-3 flex flex-col items-center justify-center w-full pt-[100px] text-white'>
                                                    <p onClick={() => {
                                    ...
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        >
                                            ...
                                            <div className=' top-3 flex flex-col items-center justify-center w-full pt-[100px] text-white'>
                                                ...
                                                <p className='text-[50px] font-bold text-white text-center flex-wrap' onClick={() => {
                                                ...
                                                <p className='mt-9 flex gap-3'>
                                                    ...
                                                    {
                                                        mode=="live" && slide1Elt.btn.btn2.lien.trim()!==""?
                                                            <Link href={slide1Elt.btn.btn2.lien}><Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style} ${mode=="live" && slide1Elt.btn.btn2.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button></Link>:
                                                            <Button onClick={() => edit({ id: "btn2", textContent: slide1Elt?.btn?.btn2?.content, type: "btn" })} color={slide1Elt?.btn?.btn2?.color} variant={slide1Elt?.btn?.btn2?.variant} className={`rounded-full ${slide1Elt?.btn?.btn2?.style} ${mode=="live" && slide1Elt.btn.btn1.hidden===true?"hidden":null}`}>{slide1Elt.btn.btn2.hidden && <EyeOff />} {slide1Elt?.btn?.btn2?.content}</Button>
                                                    }
                                                </p>
